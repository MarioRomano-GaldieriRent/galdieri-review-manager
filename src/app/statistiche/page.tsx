...
export default async function StatistichePage() {
  ...
  const mediaSettimanale =
    complete.length > 0 ? complete.reduce((s, x) => s + x.recensioni, 0) / complete.length : null;
    ...
    <main className="dash">
      ...
      <section className="card">
        ...
        <div className="stat-griglia">
          <Riquadro
            titolo="Recensioni in archivio"
            valore={cop.recensioni}
            base={`${cop.giorniCoperti} giorni coperti`}
          />
          <Riquadro
            titolo="Letture della posta"
            valore={cop.sincronizzazioni}
            base={`${cop.messaggiLetti} email lette`}
          />
          <Riquadro
            titolo="Email non interpretabili"
            valore={cop.messaggiScartati}
            base="non contenevano una recensione"
          />
          <Riquadro
            titolo="Senza punteggio"
            valore={cop.senzaPunteggio}
            base="mai contate come zero stelle"
          />
          <Riquadro
            titolo="Sede non riconosciuta"
            valore={cop.senzaSede}
            base="restano nei totali"
          />
          <Riquadro
            titolo="Possibili doppioni"
            valore={cop.possibiliDoppioni}
            base="stesso testo, chiavi diverse"
          />
        </div>
        {cop.ricostruite > 0 && (
          <p className="hint">
      ...
      <section className="card">
        ...
        <div className="stat-griglia">
          <Riquadro
            titolo="5★ senza commento"
            valore={p.cinqueSenzaCommento}
            base="il caso più automatizzabile"
          />
          <Riquadro
            titolo="5★ con commento"
            valore={p.cinqueConCommento}
            base="richiedono una risposta nel merito"
          />
      ...
      <section className="card">
        ...
        <div className="stat-griglia">
          <Riquadro
            titolo="Flussi simulati"
            valore={lav.flussiSimulati}
            base="nessuna scrittura verso l'esterno"
          />
          <Riquadro
            titolo="Flussi eseguiti davvero"
            valore={lav.flussiReali}
            base="in modalità reale"
          />
          ...
          />
          <Riquadro
            titolo="Testi riscritti a mano"
            valore={lav.riscritture}
            base="misura la qualità delle regole"
          />
